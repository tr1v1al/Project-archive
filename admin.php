...
?>	
		...
		<div id="reset-block">
			<button onclick="location.href='admin.php'">Сбросить</button>
		</div>	
	</div>
</div>
...
<div id="edit-box-wrapper" class="upload-box">
	<form class="upload-box-content popup-animation" action="edit_project.php"	
	method="POST" enctype="multipart/form-data" id="edit-box-form">
		<div class="header-block">
			<h3>Редактор проекта</h3>
			<span onclick="closeEdit(event)" class="close" title="Закрыть">&times;</span>
		</div>


		<div class="upload-block" id="edit-upload-block">
			<input type="file" name="edit_imagefile" id="edit_imagefile" class="inputfile inputfile-1">
			<label for="edit_imagefile"><span>Загрузить аватар</span></label>
			<input type="file" name="edit_textfile" id="edit_textfile" class="inputfile inputfile-1">
			<label for="edit_textfile"><span>Загрузить текст</span></label>
			<input type="file" name="edit_ppfile" id="edit_ppfile" class="inputfile inputfile-1">
			<label for="edit_ppfile"><span>Загрузить презентацию</span></label>
			<input type="file" name="edit_archive[]" id="edit_archive" class="inputfile inputfile-1" data-multiple-caption="{count} файлов выбрано" webkitdirectory multiple="">
			<label for="edit_archive"><span>Загрузить все материалы</span></label>		
			...
			placeholder="Краткое описание проекта:" maxlength="500"></textarea>				
		</div><div class="text-block" id="edit-text-block">

		
			<input type="text" name="project_name" id="edit_project_name"  
			placeholder="Название проекта" autocomplete="off" 
			maxlength="60" class="big-input">
			<input type="text" name="authors" id="edit_authors" 
			placeholder="Автор(ы) проекта" autocomplete="off" 
			maxlength="60" class="big-input">
			...
			placeholder="Дата начала: Д.М.Г" autocomplete="off" 
			maxlength="10" class="small-input">
			<input type="text" name="submit_date" id="edit_submit_date" 
			placeholder="Дата сдачи: Д.М.Г" autocomplete="off" 
			maxlength="10" class="small-input">
			...
			placeholder="Тип проекта" autocomplete="off" 
			maxlength="30" class="small-input">
			<input type="text" name="status" id="edit_status" 
			placeholder="Стадия проекта" autocomplete="off" 
			maxlength="30" class="small-input">
			<textarea name="log" id="edit_log" 
			placeholder="История проекта:" maxlength="1000"></textarea>
		</div>
		<div class="submit-block" id="edit-submit-block">
			<p id="edit-box-warning">Максимальное число файлов на загрузку 100, максимальный размер файла 100 Мб</p>
			<a href="#" id="delete-button-link" onclick="deleteProject(event)">
			<button id="delete-button" type="button" >Удалить проект</button></a>
			<button id="save-button" type="submit" name="submit">Сохранить изменения</button>
		</div>
...
<!--
<textarea name="description" id="edit_description" 
placeholder="Краткое описание проекта:" maxlength="120"></textarea>
-->
		...
		<div class=project-box>
			...
			<div class=text-display-block>
				...
				<div class="description-info-wrapper">
					...
					<div class="tooltip">
						<span class="tooltiptext"><b>Описание:</b> '.$row["description"].'</span>
					</div>
				</div>
			</div>	
			<a onclick="update('.$row["ID"].')">
			<img class="edit" src="'.$editPath.'">
			</a>
...
/*
<a onclick="deleteProject(event)" href="delete_project.php?id='.$row["ID"].'">
<img class="dustbin" src="'.$dustbinPath.'">
</a>
